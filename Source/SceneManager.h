...
public:
	...
	// set the object material into the shaders
	...
	// declare function object materials
	void DefineObjectMaterials();

	// declare function setup lights
	void SetupSceneLights();

	// stool
	void DrawStool(glm::vec3 offset, std::string seatTex, std::string legTex);
	
	// wall signs
	void DrawWallSign(glm::vec3 pos, glm::vec3 scale, float yRot, glm::vec4 color);
	
	//lanterns
	void DrawLantern(glm::vec3 pos, float scale);

	ShapeMeshes* GetMeshes();
